...
export const journey = {
  ...
  frames: {
    path: withBase('/media/journey/frame_'),
    ext: '.webp',
    pad: 4,
    count: 384,
    mobilePath: withBase('/media/journey-mobile/frame_'),
...
export const hoverLoops: Record<string, string | null> = {
  oel: withBase('/media/hover/oel.mp4'),
  kosmetik: withBase('/media/hover/kosmetik.mp4'),
  gel: withBase('/media/hover/gel.mp4'),
  balsam: withBase('/media/hover/balsam.mp4'),
  tierprodukte: withBase('/media/hover/tierprodukte.mp4'),
};
...
export const categories: Category[] = [
  { slug: 'oel',           name: 'Öl',           image: withBase('/media/products/cat-oel.webp'),          hoverLoop: hoverLoops.oel, featured: true },
  { slug: 'kosmetik',      name: 'Kosmetik',     image: withBase('/media/products/cat-kosmetik.webp'),     hoverLoop: hoverLoops.kosmetik },
  { slug: 'gel',           name: 'Gel',          image: withBase('/media/products/cat-gel.webp'),            hoverLoop: hoverLoops.gel },
  { slug: 'balsam',        name: 'Balsam',       image: withBase('/media/products/cat-balsam.webp'),       hoverLoop: hoverLoops.balsam },
  { slug: 'deocreme',      name: 'Deocreme',     image: withBase('/media/products/cat-deocreme.webp'),     hoverLoop: null, href: withBase('/produkt/bio-deocreme-rosenholz/') },
  { slug: 'tierprodukte',  name: 'Tierprodukte', image: withBase('/media/products/cat-tierprodukte.webp'),   hoverLoop: hoverLoops.tierprodukte },
];
...
export const products: Product[] = [
  P({ slug: 'bio-cbd-oel-5',  name: 'Bio-CBD-Öl 5%',  category: 'oel', price: 29.9, rating: 4.8, reviews: 41,
      image: withBase('/media/products/oel-5.webp'),
  ...
  P({ slug: 'bio-cbd-oel-7', name: 'Bio-CBD-Öl 7%', category: 'oel', price: 39.9, rating: 4.9, reviews: 87,
      image: withBase('/media/products/oel-7.webp'),
  ...
  P({ slug: 'bio-cbd-oel-19', name: 'Bio-CBD-Öl 19%', category: 'oel', price: 89.9, rating: 4.9, reviews: 34,
      image: withBase('/media/products/oel-19.webp'),
  ...
  P({ slug: 'cbd-gel-waermend-stark', name: 'CBD Gel – Wärmend Stark', category: 'gel', price: 24.9, rating: 4.7, reviews: 52,
      image: withBase('/media/products/gel.webp'),
  ...
  P({ slug: 'cbd-gel-kuehlend-stark', name: 'CBD Gel – Kühlend Stark', category: 'gel', price: 24.9, rating: 4.7, reviews: 38,
      image: withBase('/media/products/gel-kuehlend.webp'),
  ...
  P({ slug: 'cbd-balsam-waermend-stark', name: 'CBD Balsam – Wärmend Stark', category: 'balsam', price: 29.9, rating: 4.8, reviews: 63,
      image: withBase('/media/products/balsam.webp'),
      short: 'Wohltuend für Muskeln & Gelenke — wärmend, 700mg CBD.',
  ...
  P({ slug: 'cbd-balsam-kuehlend-stark', name: 'CBD Balsam – Kühlend Stark', category: 'balsam', price: 29.9, rating: 4.7, reviews: 29,
      image: withBase('/media/products/balsam-kuehlend.webp'),
      short: 'Wohltuend für Muskeln & Gelenke — kühlend, 700mg CBD.',
  ...
  P({ slug: 'tagescreme-nachtcreme-set', name: 'Tagescreme & Nachtcreme Set', category: 'kosmetik', price: 44.9, rating: 4.7, reviews: 22,
      image: withBase('/media/products/creme-set.webp'),
  ...
  P({ slug: 'bio-deocreme-rosenholz', name: 'Bio Deocreme – Rosenholz', category: 'kosmetik', price: 12.9, rating: 4.6, reviews: 19,
      image: withBase('/media/products/deocreme.webp'),
  ...
  P({ slug: 'dusch-shampoo-bergkraeuter', name: 'Dusch-Shampoo – Bergkräuter', category: 'kosmetik', price: 14.9, rating: 4.5, reviews: 17,
      image: withBase('/media/products/shampoo.webp'),
  ...
  P({ slug: 'cbd-oel-fuer-hunde', name: 'CBD-Öl für Hunde 3%', category: 'tierprodukte', price: 27.9, rating: 4.9, reviews: 58,
      image: withBase('/media/products/oel-hunde.webp'),
...
export const ambientPaths = {
  begleiter: withBase('/media/ambient/begleiter.mp4'),
  horses: withBase('/media/ambient/horses.mp4'),
  harness: withBase('/media/ambient/harness.mp4'),
  hanf: withBase('/media/ambient/hanf.mp4'),
  feld: withBase('/media/ambient/feld.mp4'),
} as const;

export const ambient = {
  begleiter: { src: null, poster: withBase('/media/ambient/begleiter.webp'), alt: 'Hofhund liegt im Gras vor Stall und Weide' },
  horses:    { src: null, poster: withBase('/media/ambient/horses.webp'),    alt: 'Arbeit mit dem Pferd am Feld' },
  harness:   { src: null, poster: withBase('/media/ambient/harness.webp'), alt: 'Kutschengeschirr des Hofkollektivs' },
  hanf:      { src: null, poster: withBase('/media/ambient/hanf.webp'),    alt: 'Junge Hanfpflanze am Feld' },
  feld:      { src: null, poster: withBase('/media/ambient/feld.webp'),    alt: 'Schwarzes Arbeitspferd im Hof vor Stall und Hanffeld' },
};
